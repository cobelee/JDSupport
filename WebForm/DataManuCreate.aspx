<%@ Page Title="新设备录入" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DataManuCreate.aspx.cs" Inherits="DataManuCreate" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa  fa-th-list"></i>新设备录入</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-table red"></i><span class="break"></span><strong>手工设备信息录入</strong></h2>
                ...
                <div class="panel-body">
                    ...
                    <asp:FormView ID="FormView1" runat="server" RenderOuterTable="False" OnItemCommand="FormView1_ItemCommand" DataSourceID="odsApp" DefaultMode="Insert" OnDataBound="FormView1_DataBound">
                        <ItemTemplate>
                        ...
                        <InsertItemTemplate>
                            <div class="form-horizontal ">
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">设备管理号</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbProductSN" runat="server" class="form-control" placeholder="四位数字"
                                            Text='<%# Eval("ProductSN") %>'></asp:TextBox>
                                        <span class="help-block">设备管理号由家电服务部编制，用于设备的管理。</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">设备大类</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbBigClass" runat="server" class="form-control" placeholder=""
                                            Text='<%# Eval("BigClass") %>'></asp:TextBox>
                                        <span class="help-block">若是空调设备，设备大类一律为“空调”，不作更改。</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">设备小类</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbAppType" runat="server" class="form-control" placeholder="如：壁挂机、柜机等"
                                            Text='<%# Eval("AppType") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">型号规格</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbModel" runat="server" class="form-control" placeholder=""
                                            Text='<%# Eval("Model") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">制冷量(KW)</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbPowerCold" runat="server" class="form-control" placeholder="填写数字，勿加单位"
                                            Text='<%# Eval("PowerCold") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">制热量(KW)</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbPowerHot" runat="server" class="form-control" placeholder="填写数字，勿加单位"
                                            Text='<%# Eval("PowerHot") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">功率(KW)</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbPower" runat="server" class="form-control" placeholder="填写数字，勿加单位"
                                            Text='<%# Eval("Power") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">品牌</label>
                                    <div class="col-md-9">
                                        <asp:TextBox ID="tbFactory" runat="server" class="form-control" placeholder="如：格力"
                                            Text='<%# Eval("Factory") %>'></asp:TextBox>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="select">设备所属公司</label>
                                    <div class="col-md-9">
                                        <asp:DropDownList ID="ddlCorp" runat="server" CssClass="form-control input-lg" Size="1"></asp:DropDownList>
                                        <span class="help-block">找不到对应公司？ 请到系统配置中，配置客户公司。</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">固定资产号</label>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">在用标记</label>
                                    <div class="col-md-9">
                                        <asp:CheckBox ID="cbIsUsing" runat="server" Checked="true" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">计划报废日期</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <p class="form-control-static">
                                            <asp:Button ID="btnCreate" runat="server" Text="保存设备信息" CssClass="btn btn-sm btn-success" CommandName="CreateApp" />
                                        </p>
                                    </div>
                                </div>
